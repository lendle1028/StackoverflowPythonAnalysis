...
public class QuestionsCrawler {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String baseUrl="https://api.stackexchange.com/2.2/questions?key=TsELULFShNfv3LtUcuTk4Q((&order=desc&sort=votes&min=10&site=stackoverflow&tagged=python&pagesize=100";
        ...
        for(int i=1; i<=1000;){
            ...
            if(json.containsKey("backoff")){
                int backoffSeconds=(int)(Double.valueOf(""+json.get("backoff")).intValue());
